...
> This web app comparing different schools data and displaying to the user to aid them make better choices
...
- To clone the project on your machine: Type `git clone https://github.com/kene-creator/zircon_wasabi-ltd.git`.
...
Feel free to check the [issues page](https://github.com/kene-creator/zircon_wasabi-ltd.git/issues).
